# 以下に javascript について有名なライブラリとその関数についての説明を記述する
    ...
    "library": [
        ...
        },
        {
            ...
            "func": [
                ...
                {
                    "name": "Router",
                    "description": "Angular Routerは、アプリケーション内のルーティングとナビゲーションを管理するためのライブラリです。これにより、SPA（Single Page Application）のページ遷移が可能になります。"
                },
                {
                    "name": "HttpClient",
...
# 以下に python について有名なライブラリとその関数についての説明を記述する
